            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, rgba(247, 149, 48, 0.4) 10%, rgba(247, 149, 48, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                    <div class="gap-4 flex flex-col items-center">
                        <div class="flex justify-center items-center border-2 border-primary rounded-full" style="width: 3.2rem; height: 3.2rem">
                            <i class="text-primary pi pi-fw pi-lock !text-2xl"></i>
                        </div>
                        ...
                        <div class="col-span-12 mt-8 text-center">
                            <Button as="router-link" label="Go to Dashboard" to="/" severity="primary" />
                        </div>
                    </div>
                </div>
            </div>
